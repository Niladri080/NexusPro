              ...
              <div className="grid md:grid-cols-3 gap-6">
                <div className="bg-gradient-to-br from-blue-600/10 to-blue-700/10 p-6 rounded-xl border border-blue-700/30">
                  ...
                  <p className="text-gray-400 text-sm">
                    Get your ATS score and feedback within seconds of uploading
                  </p>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-blue-100 mb-4">
                      Based on your target role as an AI Engineer, consider
                      adding more machine learning frameworks and cloud
                      platforms to your skills section. Highlight any experience
                      with TensorFlow, PyTorch, AWS, or Google Cloud Platform.
                    </p>
