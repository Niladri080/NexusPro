        ...
        <div className="max-w-4xl mx-auto bg-gradient-to-br from-[#1c1c1c] to-black/50 border border-blue-500/20 shadow-2xl shadow-blue-500/10 rounded-2xl">
          <div className="p-12 text-center space-y-8">
            ...
            <p className="text-xl text-gray-400 max-w-2xl mx-auto leading-relaxed">
              ...
              with AI-powered guidance. Your dream job is waiting.
            </p>
            ...
            <div className="flex flex-col gap-4 justify-center items-center pt-4">
              <button
                ...
                className="bg-gradient-to-r from-blue-500 to-blue-600 text-white hover:opacity-90 transition-opacity text-xl font-semibold px-12 py-5 rounded-lg group shadow-lg shadow-blue-500/30"
              >
                Get Started Free
